...
- Forward-pass form vs stock at effect.cap = 0.5: **CHANGED**.
...
| --- | --- | --- | --- | --- | --- | --- |
| (a) ordinary (adaptive OFF) | hinge | 0.8320372 | 0.8588714 | NA | 15 | 5.932 |
| (b) automatic adaptive cap=0.5 | linear | 0.8251368 | 0.8648205 | NA |  8 | 4.182 |
| (b) automatic adaptive cap=0.9 | hinge | 0.8318418 | 0.8583170 | NA | 15 | 5.583 |
| (c) forced-linpreds cap=0.5 | linear | 0.8251368 | 0.8648205 | NA |  8 | 3.335 |
| (c) forced-linpreds cap=0.9 | linear | 0.8259348 | 0.8658909 | NA |  8 | 3.359 |

**Form verdict (effect.cap = 0.5): YES - at effect.cap=0.5 the AUTOMATIC competition admitted `x1` as a plain LINEAR term (dirs code 2), on its own, reproducing the Stage-1 forced-linpreds form (pure linear, no knot). Ordinary earth entered it as `hinge`.**
...
**OOS verdict at scale (effect.cap = 0.5): the adaptive.gcv=TRUE path (form competition + cap shrinkage) HELPS OOS vs ordinary earth for this dataset. Forward-pass form vs stock: CHANGED.**
